...
namespace BookingAppBackend.Migrations
{
    ...
    [Migration("20200831174502_izmenaModela123")]
    partial class izmenaModela123
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookingAppBackend.Model.RentACar.Car", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookingAppBackend.Model.RentACar.CarRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookingAppBackend.Model.RentACar.DiscountBasedOnPoints", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("DiscountsBasedOnPoints");
                });

            modelBuilder.Entity("BookingAppBackend.Model.RentACar.Enterprise", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookingAppBackend.Model.RentACar.EnterpriseAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookingAppBackend.Model.RentACar.EnterpriseBranch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("EnterpriseBranches");
                });

            modelBuilder.Entity("BookingAppBackend.Model.RentACar.EnterpriseRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookingAppBackend.Model.RentACar.UserCarReservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("UserCarReservation");
                });

            modelBuilder.Entity("BookingAppBackend.Model.Users.Admin", b =>
                {
                    b.Property<string>("Username")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BookingAppBackend.Model.Users.RentACarAdmin", b =>
                {
                    b.Property<string>("Username")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BookingAppBackend.Model.RentACar.Enterprise", b =>
                {
                    b.HasOne("BookingAppBackend.Model.RentACar.EnterpriseAddress", "Address")
                        .WithMany()
                        .HasForeignKey("AddressId");
                });
